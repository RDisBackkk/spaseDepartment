...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full px-6 lg:px-10 pt-8 pb-20">
      <div className="w-full mx-auto flex flex-col min-h-[80vh]">
...
>
  ...
  />
              ...
              <span className="block text-[#1A4DFF]">{hero.titleHighlight}</span>
            </h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-12 items-end gap-y-8 gap-x-6 mt-12">
          ...
          <div className="col-span-12 lg:col-span-3 flex items-center gap-2 min-w-0">
            <div className="font-bold text-[22px] shrink-0">{hero.footerPrefix}</div>
            <div className="text-[18px] text-[#111111] min-w-0">{hero.footerText}</div>
          </div>
          ...
          <div className="col-span-12 lg:col-start-4 lg:col-span-5">
            <button className="w-full bg-[#1A4DFF] hover:bg-[#0036FF] transition-colors text-white py-5 px-8 rounded-sm font-bold uppercase tracking-wide text-[14px] flex items-center justify-center gap-3">
              ...
              <svg
                ...
                viewBox="0 0 8 11"
              >
                <circle cx="2.429" cy="2.358" r="1.111" className="fill-current" transform="rotate(45 2.429 2.358)" />
                <circle cx="5.571" cy="5.5" r="1.111" className="fill-current" transform="rotate(135 5.571 5.5)" />
                <circle cx="2.429" cy="8.642" r="1.111" className="fill-current" transform="rotate(135 2.429 8.642)" />
              </svg>
            </button>
          </div>
          ...
          <div className="col-span-12 lg:col-start-10 lg:col-span-3">
            <div className="text-[#1A4DFF] text-[28px] leading-none mb-3">✳</div>
