  ...
  return (
    ...
    >
      <div className="relative w-full">
        ...
        <div
          className="flex w-full overflow-x-scroll overscroll-x-auto py-10 [scrollbar-width:none] snap-x snap-mandatory scroll-pl-[6.5vw]"
          ref={carouselRef}
          onScroll={() => {
            checkScrollability();
            checkActiveCard();
          ...
          >
            {items.map((item, index) => (
              <motion.div
                ...
                key={"card" + index}
                className="rounded-3xl carousel-card-item snap-start flex-shrink-0"
              >
                {item}
              </motion.div>
            ))}
